...
class ListD
{
    ...
    private:
        ...
        */
        ...
        /*
        Comment: Used in the selection sort function to find address of smallest nod
        pre: the integer position of how far deep into the list you are
        post: returns the address of the node with smallest item value
        */
        doubleNode<T>* findSmall(int start);

        /*
        Comment: Used in selection sort to swap the positions of two nodes
        pre: takes in the position of node to be swapped and address of smallest node
        post: nodes swap position
        */
        void Swap(int pos, doubleNode<T>* smallNode); 
