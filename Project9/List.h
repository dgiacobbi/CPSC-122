...
class List
{
     public:
          ...
          pre: None. This is the constructor function, 
               invoked like this from the the client program.
          post: an instance of List exists
          */ 
          List();

          /*
          pre: An instance of List exists.  This is the destructor 
               function, automatically invoked in the case of a static 
               declaration, explcitly invoked, using the delete
               key word, in the case of a dynamic declaration.	
          post: All dynamically declared memory, i.e., the memory 
                for all nodes, has been returned to the heap.   
          */ 
          ~List();
          ...
          */
          ...
          post: Returns the contents pointed to by the 
                head of the list 
          */
          ...
          */
          ...
          /*
          pre: an instance of list exists and is not empty
          post: contents of list nodes are displayed on subsequent 
                lines, head to tail. 
          */
          void Print() const;
